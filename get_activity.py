...
def main():
    ...
    try:
        ...
        log.error("login: %s password: %s", args.username, args.password)
        with GarminClient(args.username, args.password, user_agent_fn=lambda:DEFAULT_USER_AGENT) as client:
